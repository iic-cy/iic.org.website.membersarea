...
if (isset($_SERVER['HTTP_ORIGIN'])) {
    ...
    header("Access-Control-Allow-Headers: Content-Type, Authorization,pragma,x-api-key,cache-control,referrer-policy,x-frame-options,x-content-type-options,x-signature,x-nonce,x-client-version,x-timestamp,expires");
}
